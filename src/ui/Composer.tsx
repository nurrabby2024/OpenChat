...
export function Composer(props: {
  ...
  const estCost = useMemo(() => {
    // Fast, approximate UI-only estimate
    // Typical L2 tx: ~0.00001–0.0002 ETH depending on calldata
    const base = 0.000015;
    const perChar = 0.0000000002;
    const v = base + perChar * charCount;
    return v;
  }, [charCount]);
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="flex-1">
            <textarea
              ...
              onKeyDown={onKeyDown}
              disabled={!props.connected || sending || props.disabled}
              rows={1}
              className={[
            ...
            <div className="mt-2 flex items-center justify-between text-xs font-mono text-muted">
              <div className="flex items-center gap-3">
                <span>Est. cost ~{estCost.toFixed(6)} ETH</span>
